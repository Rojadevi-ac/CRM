...
export default function Modal({ isOpen, onClose, title, children, maxWidth = 'max-w-2xl' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      {/* Modal Dialog */}
      <div
        className={`relative w-full ${maxWidth} bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-2xl shadow-soft-xl border border-slate-200/80 dark:border-slate-800/80 overflow-hidden transform transition-all z-10 my-8 animate-scaleIn`}
      >
        {/* Header */}
